...
const translations: Record<string, Translations> = {
  ...
  'hu': {
    ...
    'Only image files are allowed': 'Csak képfájlok engedélyezettek',
    'Add caption (optional)': 'Képaláírás (nem kötelező)',
    'Maximum 10 files': 'Legfeljebb 10 fájl',
    'Attach image': 'Kép csatolása',
    'Uploading...': 'Feltöltés...',
    'Unknown': 'Ismeretlen',
